    ...
    "${config.xdg.configHome}/matugen/templates/opencode-theme.json".text = ''
      {
        ...
        "colors": {
          ...
          "backgroundElevated": "{{colors.surface_container_high.default.hex}}",
          "foreground": "{{colors.on_surface.default.hex}}",
          "foregroundMuted": "{{colors.outline.default.hex}}",
          "border": "{{colors.outline_variant.default.hex}}",
          "primary": "{{colors.primary.default.hex}}",
          "primaryForeground": "{{colors.on_primary.default.hex}}",
          "secondary": "{{colors.tertiary.default.hex}}",
          "secondaryForeground": "{{colors.on_tertiary.default.hex}}",
